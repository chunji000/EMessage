...
public class JpushClientUtil {
    ...
    private final static String appKey = "7fed316c23ce683b5d6b5f2c";
 
    private final static String masterSecret = "e11c0045ce07bfce292bc57c";
 
    private static JPushClient jPushClient = new JPushClient(masterSecret,appKey);
 
    /**
     * 推送给别名：teacher或student用户
     * @param alias 消息发送到的别名用户
     ...
     * @return 0推送失败，1推送成功
     */
    public static int sendAndroidMessageWithAlias(String alias,String notification_title, String msg_title, String msg_content, String extrasparam) {
        int result = 0;
        try {        	    
            PushResult pushResult=jPushClient.sendAndroidMessageWithAlias(msg_title, msg_content, alias);
    ...
    public static void main(String[] args){
        if(JpushClientUtil.sendToRegistrationId("11","testAndroid","标题：国际影星李春吉开始炒股了","this is a Android Dev test--李春吉","")==1){
