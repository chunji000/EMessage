...
public class VMenutreeInfo {
	...
	private List<VMenutreeInfo> children;//: 一个节点数组,定义一些子节点
	public String getId() {
		return id;
	}
	...
	public List<VMenutreeInfo> getChildren() {
		return children;
	}
	public void setChildren(List<VMenutreeInfo> children) {
